...
Route::get('dashboard', 'HomeController@index')->name('home');
    ...
    Route::PATCH('/profile/{profile}', 'ProfileController@updateProfile')->name('update_profile');
    Route::PATCH('/profile/photo/{profile}', 'ProfileController@changePic')->name('changePic');
