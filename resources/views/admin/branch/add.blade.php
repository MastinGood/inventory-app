                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form id="demo-form2" method="POST" action="{{route('branch.store')}}" data-parsley-validate class="form-horizontal form-label-left">
                          @csrf
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Branch Name <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" name="branchname" id="first-name" required="required" class="form-control col-md-7 col-xs-12 {{ $errors->has('branchname') ? ' is-invalid' : '' }}" value="{{old('branchname')}}">
