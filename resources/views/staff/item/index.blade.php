          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="title_right">
                    <a href="{{route('item.add')}}" class="btn btn-info btn-lg pull-right up"><img src="{{asset('images/add.png')}}" height="25" width="25"> Add ITEM </a>
              </div>
             <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="row">
                        <div class="col-md-12">
                           <form class="form-horizontal" action="{{route('item.search')}}" method="POST">
                              @csrf
                              <div class="col-md-6">
