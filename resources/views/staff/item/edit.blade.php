            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" action="{{route('item.update', ['id' => $item->id])}}" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                      @method('PATCH');
                      @csrf
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control col-md-7 col-xs-12{{ $errors->has('type') ? ' is-invalid' : '' }}" name="type">
                            @if(count($types))
                              ...
                              <option value="{{$type->id}}" @if($item->type == $type->id) selected="selected" @else @endif>{{$type->type}}</option>
                              @endforeach
                            @endif
                          </select>
                            @if ($errors->has('type'))
